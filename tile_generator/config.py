	...
	def build_job_manifest(self, job):
		...
		manifest = {
			...
			'uaa': {
				...
				'tile_installer_client_id': '(( ..cf.uaa.tile_installer_client_credentials.value_present? ? ..cf.uaa.tile_installer_client_credentials.identity : [] ))',
				'tile_installer_client_secret': '(( ..cf.uaa.tile_installer_client_credentials.value_present? ? ..cf.uaa.tile_installer_client_credentials.password : [] ))',
			},
